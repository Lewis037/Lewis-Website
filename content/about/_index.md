...
I have a high level of understanding in Unreal engine and how to make different features as I have used a large variety of the different features that Unreal has to offer like enumerators, behaviour trees, timeline, components to name a few. I've worked on multiple different mechanics across projects I have worked on like a climbing system inspired from Uncharted. One of the projects I heavily worked on is a first person stealth game called Kagemusha in which you are an assassin sent to kill a strange powerful figure that lives atop a huge mountain.

I also have some experience with Godot game engine as during a Ukie game jam, my group and I used Godot game engine for the theme 'Symmetry' to make a vampire survivors inspired game called 'Symmetry Survivors'.
