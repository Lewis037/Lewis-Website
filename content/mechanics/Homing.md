...
<img src="/Kagemusha/Homing/Homing1.gif" alt="Homing Projectile 1" style="width:100%">

Moves at a set speed regardless of distance to the target
<img src="/Kagemusha/Homing/Homing2.gif" alt="Homing Projectile 2" style="width:100%">

Checks for if anything is blocking the path
<img src="/Kagemusha/Homing/Homing3.gif" alt="Homing Projectile 3" style="width:100%">

## Code Snippets
![invalid](/Kagemusha/Homing/CS_Homing1.png)

![invalid](/Kagemusha/Homing/CS_Homing2.png)
...
![invalid](/Kagemusha/Homing/CS_Homing3.png)
